...
export default function Hero() {
  const valueItems = [
    [
      'Diagnóstico',
      'Analizo procesos, requerimientos y objetivos del negocio antes de definir una solución tecnológica.',
    ],
    [
      'Arquitectura',
      'Diseño la estructura del sistema: frontend, backend, datos, integraciones, seguridad e infraestructura.',
    ],
    [
      'Desarrollo',
      'Construyo plataformas web, APIs, sistemas internos y automatizaciones con foco en calidad y mantenibilidad.',
    ],
    [
      'Producción',
      'Realizo despliegue, configuración, documentación técnica y acompañamiento posterior a la entrega.',
    ],
  ]
    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-10 px-5 py-10 md:px-6 lg:min-h-[calc(100vh-73px)] lg:grid-cols-[1fr_0.9fr] lg:items-center lg:py-8 xl:py-0">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 max-w-2xl text-base leading-relaxed text-slate-600 xl:text-lg">
          ...
          <div className="mt-7 flex flex-col gap-3 sm:flex-row">
            <a
              href="#contact"
              className="bg-slate-950 px-7 py-4 text-center font-semibold text-white transition hover:bg-slate-800"
              aria-label="Conversar sobre un proyecto de software"
            >
              Conversar proyecto
            </a>
            ...
            <a
              href="#services"
              className="border border-slate-300 px-7 py-4 text-center font-semibold text-slate-950 transition hover:bg-white"
              aria-label="Ver servicios de desarrollo de software"
            >
              Ver servicios
            </a>
          </div>
          ...
          >
            {[
              ...
              >
                <p className="text-xl font-bold xl:text-2xl">{number}</p>
        ...
        <article className="relative w-full lg:pl-4">
          ...
          <aside className="mt-4 bg-[#c6a15b] p-5 text-white shadow-xl lg:ml-auto lg:max-w-md xl:p-6">
